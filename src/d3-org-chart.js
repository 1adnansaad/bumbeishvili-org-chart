        ...
        const attrs = {
            ...
            */
            ...
            buttonContent: ({ node, state }) => {
                ...
                return `<div style="border:1px solid #E4E2E9;border-radius:3px;padding:3px;font-size:9px;margin:auto auto;background-color:white"> ${(icons[state.layout] || icons.top)(node.children)}  </div>`
            },
